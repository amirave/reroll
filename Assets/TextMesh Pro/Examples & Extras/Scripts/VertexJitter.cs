...
namespace TMPro.Examples
{
    ...
    public class VertexJitter : MonoBehaviour
    {
        ...
        /// </summary>
        /// <returns></returns>
        async void AnimateVertexColors()
        {
            ...
            while (true)
            {
                ...
                for (int i = 0; i < characterCount; i++)
                {
                    ...
                    var jitterOffset = new Vector3(Mathf.Sin(Time.unscaledTime * SpeedMultiplier * 0.5f + i * CurveOffset), 
                        Mathf.Cos(Time.unscaledTime * SpeedMultiplier * 0.3f + i * CurveOffset));
